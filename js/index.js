...
// const phoneInputt=document.getElementById("phoneInput");
...
let phone_regex=/^[\+]?[(]?[0-9]{3}[)]?[-\s\.]?[0-9]{3}[-\s\.]?[0-9]{4,6}$/;
let pass_regex=/^(?=.*\d)(?=.*[a-z])(?=.*[A-Z])(?=.*[a-zA-Z]).{8,}$/;
...
function nameValidation() {
    return (name_regex.test(document.getElementById("nameInput").value))
}

function emailValidation() {
    return (regex_email.test(document.getElementById("emailInput").value))
}

function phoneValidation() {
    return (phone_regex.test(document.getElementById("phoneInput").value))
}

function ageValidation() {
    return (age_regex.test(document.getElementById("ageInput").value))
}

function passwordValidation() {
    return ( pass_regex.test(document.getElementById("passwordInput").value))
}
